...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { description: @name.description, price: @name.price, sku: @name.sku, stock: @name.stock } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { description: @name.description, price: @name.price, sku: @name.sku, stock: @name.stock } }
